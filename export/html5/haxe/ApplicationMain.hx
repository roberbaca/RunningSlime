...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("running_slime", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("running_slime", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "running_slime";
		app.meta["name"] = "Running Slime";
